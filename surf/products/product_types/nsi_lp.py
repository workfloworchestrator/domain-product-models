...
class NsiLightPathInactive(SubscriptionModel, is_base=True):
    domain: Domain
    vc: Sn8LightPathVirtualCircuitBlockInactive


class NsiLightPathProvisioning(NsiLightPathInactive, lifecycle=[SubscriptionLifecycle.PROVISIONING]):
    domain: Domain
    vc: Sn8LightPathVirtualCircuitBlockProvisioning


class NsiLightPath(NsiLightPathProvisioning, lifecycle=[SubscriptionLifecycle.ACTIVE]):
